    ...
    return (
        <div className="container about-page" >
            <div className="text-zone1">
                ...
                <h3>System Architecture and Operating Systems</h3>
                ...
                <h3>Computer Graphics fundamentals: Path tracer</h3>
                ...
                <h3>Complex Software Architecture</h3>
