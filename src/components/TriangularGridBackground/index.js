...
const TriangularGridBackground = ({
    ...
    const colorTheme = {
        ...
        background: backgroundColor === 'transparent'
            ...
            : backgroundColor === 'auto'
                ? `rgb(${Math.max(5, primaryColor.r * 0.02)}, ${Math.max(8, primaryColor.g * 0.03)}, ${Math.max(15, primaryColor.b * 0.05)})`
                : backgroundColor,
        ...
        get triangleFillColor() {
            return triangleFill
                ? (backgroundColor === 'transparent' ? 'rgba(0, 0, 0, 0.03)' : this.background)
                : 'transparent';
        }
    };
        ...
        for (let col = 0; col < cols; col++) {
            ...
            triangles.push(
                <path
                    ...
                    fill={colorTheme.triangleFillColor}  // ← HIER: Verwendet triangleFillColor
                    stroke="none"
                />
            );
